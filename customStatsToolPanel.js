...
CustomStatsToolPanel.prototype.init = function (params) {
    ...
    var renderStats = function () {
        _this.eGui.innerHTML = calculateStats(params);
    };
...
function calculateStats(params) {
    ...
    return (
        ...
        '</b></dt>' +
        '<dt style="padding-bottom: 15px">Total Gold: <b>' +
        numGold +
        '</b></dt>' +
        '<dt style="padding-bottom: 15px">Total Silver: <b>' +
        numSilver +
        '</b></dt>' +
        '<dt style="padding-bottom: 15px">Total Bronze: <b>' +
        numBronze +
        '</b></dt>' +
        '</dl>' +
        '</span>'
